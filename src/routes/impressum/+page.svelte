<section class="mx-auto max-w-5xl px-3 py-3">
	<h2><strong>Angaben gemäß § 5 TMG</strong></h2>
	<p>
		Jonathan Martz Software Entwicklung<br /> Othestrasse 2<br /> 51702 Bergneustadt <br /><br />
	</p>
	<h2><strong>Vertreten durch:</strong></h2>
	<p>Jonathan Martz<br /><br /></p>
	<h2><strong>Kontakt:</strong></h2>
	<p>
		E-Mail: <a href="mailto:impresum@jonathan-martz.de">impressum@jonathan-martz.de </a><br /><br />
	</p>
	<h2><strong>Haftungsausschluss:</strong></h2>
	<p>
		<br /><br /><strong>Haftung für Inhalte</strong><br /><br /> Die Inhalte unserer Seiten wurden
		...
		/><strong>Haftung für Links</strong><br /><br /> Unser Angebot enthält Links zu externen
		...
		<br /><br /><strong>Urheberrecht</strong><br /><br /> Die durch die Seitenbetreiber erstellten
		...
		umgehend entfernen. <br /><br /><strong>Datenschutz</strong><br /><br /> Die Nutzung unserer
		...
		ausdrückliche Zustimmung nicht an Dritte weitergegeben. <br /> Wir weisen darauf hin, dass die
	...
	<p>
		...
		Hostname des zugreifenden Rechners<br /> · Uhrzeit der Serveranfrage<br /> · IP-Adresse<br /><br
